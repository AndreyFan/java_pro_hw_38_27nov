...
public class ProductsService {
    ...
    void initProducts() {
        ...
        ProductsEntity productsEntity1 = new ProductsEntity((Long) null, "Milk", "Fresh liter of milk", 1.2, "https://example.com/milk.jpg", 0.0, dateCr, dateUp);
        productsRepository.save(productsEntity1);
        ProductsEntity productsEntity2 = new ProductsEntity(null, "Bread", "Fresh loaf of bread", 0.8, "https://example.com/bread.jpg", 10.0, dateCr, dateUp);
        productsRepository.save(productsEntity2);

        ProductsEntity productsEntity3 = new ProductsEntity((Long) null, "Dishwashing Liquid", "For cleaning dishes", 2.5, "https://example.com/detergent.jpg", 5.0, dateCr, dateUp);
        productsRepository.save(productsEntity3);
        ProductsEntity productsEntity4 = new ProductsEntity(null, "Glass Cleaner", "Effective glass cleaner", 3.0, "https://example.com/glass_cleaner.jpg", 0.0, dateCr, dateUp);
        productsRepository.save(productsEntity4);

        ProductsEntity productsEntity5 = new ProductsEntity((Long) null, "Television", "LED TV", 150.0, "https://example.com/tv.jpg", 3.5, dateCr, dateUp);
        productsRepository.save(productsEntity5);
        ProductsEntity productsEntity6 = new ProductsEntity(null, "Radio", "FM radio receiver", 30.0, "https://example.com/radio.jpg", 3.5, dateCr, dateUp);
        productsRepository.save(productsEntity6);

        ProductsEntity productsEntity7 = new ProductsEntity((Long) null, "Teddy Bear", "Plush teddy bear", 10.0, "https://example.com/teddy_bear.jpg", 0.0, dateCr, dateUp);
        productsRepository.save(productsEntity7);
        ProductsEntity productsEntity8 = new ProductsEntity(null, "Building Blocks", "Kids' building blocks set", 15.0, "https://example.com/blocks.jpg", 0.0, dateCr, dateUp);
        productsRepository.save(productsEntity8);

        ProductsEntity productsEntity9 = new ProductsEntity((Long) null, "T-Shirt", "Graphic T-shirt", 12.0, "https://example.com/tshirt.jpg", 10.0, dateCr, dateUp);
        productsRepository.save(productsEntity9);
        ProductsEntity productsEntity10 = new ProductsEntity(null, "Jeans", "Stylish jeans", 25.0, "https://example.com/jeans.jpg", 20.0, dateCr, dateUp);
        productsRepository.save(productsEntity10);

        ProductsEntity productsEntity11 = new ProductsEntity((Long) null, "Notebook", "School notebook", 1.5, "https://example.com/notebook.jpg", 0.0, dateCr, dateUp);
        productsRepository.save(productsEntity11);
        ProductsEntity productsEntity12 = new ProductsEntity(null, "Pen", "Gel pen", 0.5, "https://example.com/pen.jpg", 0.0, dateCr, dateUp);
